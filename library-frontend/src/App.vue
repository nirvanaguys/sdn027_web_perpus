<template>
  <div
    class="min-h-screen bg-slate-50 flex flex-col font-sans selection:bg-indigo-500 selection:text-white"
  >
    <Navbar />
    <main class="flex-1">
      <router-view />
    ...
    <footer class="bg-white border-t border-slate-200/80 py-8 mt-16">
      <div
